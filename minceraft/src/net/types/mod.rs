...
// TODO: Properly implement a particle data type
pub struct Particle;

impl Encoder for Particle {
    fn write_to(&self, _w: &mut impl io::Write) -> Result<()> {
        todo!()
    }
}

impl Decoder for Particle {
    fn read_from(_r: &mut impl io::Read) -> Result<Self> {
        todo!()
    }
}
